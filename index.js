...
bot.on('message', async message => {
  if (message.content === 'n!owner') {
    message.channel.send(`The creator its @Frealac#0001`);
  }
});

bot.on('message', async message => {
  if (message.content === 'n!invite') {
    message.channel.send(`> Site Web : https://natexweb.glitch.me/index.html`);
    message.channel.send(`> Bot Invite : https://bit.ly/invitenatex`);
  }
});
